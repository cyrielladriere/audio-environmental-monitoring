import os
from compression.evaluation import evaluate
import pandas as pd
import cv2 as cv
...
def main():
    ...
    float_model = load_model("mbv2/mobilenet_v2.pth").to(device)
    ...
    top1, top5, _ = evaluate(float_model, val_dataloader)
    print('Evaluation accuracy on %d images, %2.2f'%(num_eval_batches * batch_size, top1.avg))
    # torch.jit.save(torch.jit.script(float_model), "mbv2/mobilenet_v2.pth")
    return
